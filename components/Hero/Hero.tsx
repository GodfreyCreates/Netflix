...
export const Hero = () => {
  return (
    <section className="">
      <Navbar/>
      <div className="relative flex flex-col items-center justify-center min-h-[90vh] text-white">
        <div
        ...
        <div className="relative z-10 text-center px-4 sm:px-8 md:px-12 lg:px-16">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center mt-4 gap-2">
            <Input
              ...
              className="rounded w-full sm:w-auto p-3 sm:p-4 md:p-5 lg:p-6 text-base sm:text-lg md:text-md lg:text-lg"
            />
            <Button className="rounded p-3 sm:p-4 md:p-5 lg:p-6 text-base sm:text-lg md:text-md lg:text-lg flex items-center mt-4 sm:mt-0">
